...
/**
 * A class representing the main core of the plane
 * This plane has 2 classes (economy and first) which
 * are full of seats
...
public class Airplane {
	...
	/**
	 * A private helper method to populate the seats in economy class
	 * Each seat is set up specifically according to the instructions
	...
	/**
	 * A private helper method to populate the seats in first class
	 * Each seat is set up specifically according to the instructions
